...
import com.example.guzellikappp.Adapters.SacMaskesiAdapter;
import com.example.guzellikappp.R;


public class FragmentSac extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        SacMaskesiAdapter adapter=new SacMaskesiAdapter(getActivity());
